...
def test_cache_manager():
    ...
    assert hasattr(cache_manager, 'get_query_result'), "get_query_result method not found!"
    assert hasattr(cache_manager, 'set_query_result'), "set_query_result method not found!"
...
def simulate_graphql_query():
    ...
    try:
        ...
        # Try to get it back
        new_cached_result = cache_manager.get_query_result(query_string, variables, user_id)
