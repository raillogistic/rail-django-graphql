...
def test_nested_crud_operations():
    ...
    comment1 = Comment.objects.create(
        content="Test comment 1 - original", author=user, post=post
    )
    comment2 = Comment.objects.create(
        content="Test comment 2 - original", author=user, post=post
    )
    comment3 = Comment.objects.create(
        content="Test comment 3 - to be deleted", author=user, post=post
    )
    ...
    try:
        ...
        if updated_comment1.content == "Test comment 1 - UPDATED":
            ...
            print(
                f"ERROR - Comment 1 content is '{updated_comment1.content}', expected 'Test comment 1 - UPDATED'"
            )
            success = False
    ...
    try:
        ...
        if updated_comment2.content == "Test comment 2 - UPDATED":
            ...
            print(
                f"ERROR - Comment 2 content is '{updated_comment2.content}', expected 'Test comment 2 - UPDATED'"
            )
            success = False
    except Comment.DoesNotExist:
