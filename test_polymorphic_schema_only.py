...
def test_polymorphic_type_in_schema():
    ...
    try:
        ...
        polymorphic_type_found = any('polymorphicType' in field or 'polymorphic_type' in field for field in client_type_fields)
        
        if polymorphic_type_found:
            print("\n✅ SUCCESS: polymorphic_type field found in ClientType!")
            polymorphic_field = next(field for field in client_type_fields if 'polymorphicType' in field or 'polymorphic_type' in field)
