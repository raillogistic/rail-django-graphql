...
def check_input_types():
    ...
    create_comment_fields = {k: v for k, v in create_fields.items() if 'comment' in k.lower()}
    update_comment_fields = {k: v for k, v in update_fields.items() if 'comment' in k.lower()}
