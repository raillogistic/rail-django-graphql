...
from django_graphql_auto.generation import TypeGenerator
...
from django_graphql_auto.security import (
    PermissionChecker, 
    InputValidator, 
    RateLimiter
)
...
from django_graphql_auto import AutoGraphQLSchema
...
from django.contrib.auth.models import AnonymousUser
from graphene.test import Client
from django_graphql_auto.security import JWTAuthenticationMiddleware
from tests.fixtures.factories import UserFactory
...
jobs:
  test:
    ...
    - name: Run unit tests
      run: pytest tests/unit/ -v --cov=django_graphql_auto
