...
from rail_django_graphql.extensions.health import HealthQuery
...
print(
    f'health_status field resolver: {health_status_field.resolve if health_status_field else "Not found"}'
)
print(
    f'system_metrics field resolver: {system_metrics_field.resolve if system_metrics_field else "Not found"}'
)
