...
def test_original_issue():
    ...
    try:
        ...
        user = User.objects.create_user(username='test_user_57', email='test57@test.com')
        user.pk = 57
        user.save()
    ...
    try:
        ...
        comment = Comment.objects.create(content='Original comment', author=user, post=post)
        comment.pk = 82
        comment.save()
