...
-   **Details**:
    -   In `requirements/base.txt`, add the line:
        ...
        ```
    -   Add other Django and application-specific dependencies. ✅ (including `psutil` fix)
...
-   **Details**:
    -   Execute GraphQL queries and mutations to ensure the schema generated by the library works as expected. ✅ (GraphiQL loads, health endpoints wired)
