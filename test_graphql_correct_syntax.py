...
def test_graphql_correct_syntax():
    ...
    if result3.get('errors'):
        ...
        print(f"  Success: Found {data['page_info']['total_count']} comments with 'test'")
    print()
    ...
    if users:
        ...
        if result4.get('errors'):
            ...
            print(f"  Success: Found {data['page_info']['total_count']} comments by author")
        print()
    ...
    if len(users) >= 2:
        ...
        if result5.get('errors'):
            ...
            print(f"  Success: Found {data['page_info']['total_count']} comments by multiple authors")
        print()
