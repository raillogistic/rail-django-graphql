...
from rail_django_graphql.core.registry import SchemaRegistry, SchemaInfo
...
class TestMultiSchemaRouting(TestCase):
    ...
    def test_graphql_playground_view(self, mock_registry):
        ...
        request = Mock()
        request.method = 'GET'
        request.build_absolute_uri.return_value = 'http://testserver/graphql/test_schema1/'
...
class TestMultiSchemaURLIntegration(TestCase):
    ...
    def setUp(self):
        ...
        mock_schema = Mock()
        mock_schema.execute.return_value = Mock(
            data={"hello": "world"},
            errors=None
        )
    ...
    def test_multi_schema_url_routing(self, mock_registry):
        ...
        with patch('rail_django_graphql.views.graphql_views.MultiSchemaGraphQLView.dispatch') as mock_dispatch:
    ...
    def test_schema_list_url(self, mock_registry):
        ...
        with patch('rail_django_graphql.views.graphql_views.SchemaListView.get') as mock_get:
    ...
    def test_playground_url(self, mock_registry):
        ...
        with patch('rail_django_graphql.views.graphql_views.GraphQLPlaygroundView.get') as mock_get:
