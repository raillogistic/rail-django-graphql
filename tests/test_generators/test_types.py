...
from django_graphql_auto.generators.types import (
    TypeGenerator,
    GraphQLTypeInfo,
    FieldMapping,
    get_graphql_type_for_field
)
from django_graphql_auto.generators.introspector import ModelIntrospector, FieldInfo
...
class TestTypeGenerator(TestCase):
    ...
    def test_generate_type_fields_mapping(self):
        ...
        expected_fields = [
            'nom_utilisateur', 'adresse_email', 'date_inscription',
            'est_actif', 'age_utilisateur', 'score_reputation'
        ]
    ...
    @patch('django_graphql_auto.generators.types.logger')
