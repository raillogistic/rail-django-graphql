...
class TestNestedFieldFiltering(TestCase):
    ...
    def test_generator_initialization(self):
        ...
        custom_generator = AdvancedFilterGenerator(
            max_nested_depth=2, enable_nested_filters=False
        )
    ...
    def test_depth_validation(self):
        ...
        self.assertEqual(
            generator.max_nested_depth, 5
        )  # Should be clamped to MAX_ALLOWED_NESTED_DEPTH
    ...
    def test_nested_text_filters(self):
        ...
        filters = self.generator._generate_nested_text_filters(
    ...
    def test_nested_numeric_filters(self):
        ...
        filters = self.generator._generate_nested_numeric_filters(
            "brand__founded_year", "brand"
        )
    ...
    def test_nested_boolean_filters(self):
        ...
        filters = self.generator._generate_nested_boolean_filters(
            "is_active", "product"
        )
    ...
    def test_performance_score_calculation(self):
        ...
        complex_filters = {
            f"field_{i}__very__deeply__nested__value": "test" for i in range(15)
        }
...
class TestNestedFilteringIntegration(TestCase):
    ...
    def setUp(self):
        ...
        self.brand = Brand.objects.create(
            name="TechCorp", country=self.country, founded_year=1995
        )
    ...
    def test_real_model_filter_generation(self):
        ...
        simple_filter_data = {"name__icontains": "Smartphone"}
        simple_filtered_instance = filter_set(
            data=simple_filter_data, queryset=Product.objects.all()
        )
        simple_filtered_data = simple_filtered_instance.qs
        print(f"Simple filter result count: {simple_filtered_data.count()}")

        # Test filter application
        filter_data = {"brand__country__name__icontains": "États"}
