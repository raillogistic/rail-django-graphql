...
class MockRelatedModel(models.Model):
    ...
    parent = models.ForeignKey(MockModel, on_delete=models.CASCADE, verbose_name="Parent")
...
class MockDeeplyNestedModel(models.Model):
    ...
    related = models.ForeignKey(MockRelatedModel, on_delete=models.CASCADE, verbose_name="Lié")
...
class TestNestedFilteringPerformanceAnalysis(TestCase):
    ...
    def test_moderate_complexity_filter_analysis(self):
        ...
        analysis = self.generator.analyze_query_performance(MockDeeplyNestedModel, moderate_filters)
    ...
    def test_depth_calculation_accuracy(self):
        ...
        for filter_name, expected_depth in test_cases:
            ...
            self.assertEqual(analysis['max_depth'], expected_depth, 
    ...
    def test_select_related_suggestions(self):
        ...
        with patch.object(MockDeeplyNestedModel._meta, 'get_field') as mock_get_field:
            ...
            analysis = self.generator.analyze_query_performance(MockDeeplyNestedModel, filters_with_foreign_keys)
    ...
    def test_prefetch_related_suggestions(self):
        ...
        with patch.object(MockModel._meta, 'get_field') as mock_get_field:
            ...
            analysis = self.generator.analyze_query_performance(MockModel, filters_with_reverse_relations)
    ...
    def test_n_plus_one_risk_detection(self):
        ...
        with patch.object(MockModel._meta, 'get_field') as mock_get_field:
            ...
            analysis = self.generator.analyze_query_performance(MockModel, risky_filters)
    ...
    def test_recommendation_generation(self):
        ...
        with patch.object(MockDeeplyNestedModel._meta, 'get_field') as mock_get_field:
            ...
            analysis = self.generator.analyze_query_performance(MockDeeplyNestedModel, complex_filters)
...
class TestNestedFilteringQuerySetOptimization(TestCase):
    ...
    def test_get_optimized_queryset_with_select_related(self, mock_logger):
        ...
        with patch.object(MockDeeplyNestedModel.objects, 'all', return_value=mock_queryset):
            ...
            with patch.object(self.generator, 'analyze_query_performance') as mock_analysis:
                ...
                optimized_qs = self.generator.get_optimized_queryset(MockDeeplyNestedModel, filters)
                
                # Verify select_related was called
                mock_queryset.select_related.assert_called_once_with('related', 'related__parent')
...
class TestNestedFilteringPerformanceEdgeCases(TestCase):
    ...
    def test_very_deep_nesting_performance_impact(self):
        ...
        analysis = self.generator.analyze_query_performance(MockModel, very_deep_filters)
    ...
    def test_performance_analysis_serialization(self):
        ...
        filters = {
            'related__field__value': 'test',
            'another__nested__field': 'test'
        }
    ...
    def test_performance_monitoring_integration(self):
        ...
        with patch('django_graphql_auto.generators.filters.logger') as mock_logger:
            analysis = self.generator.analyze_query_performance(MockModel, filters)
