...
def test_property_filtering_functionality():
    ...
    client1 = Client.objects.create(raison="tech company")
    client2 = Client.objects.create(raison="consulting firm")
    client3 = Client.objects.create(raison="software house")
    ...
    Post.objects.create(
        title="Tech Post 1", content="Content 1", category=category1, is_published=True
    )
    Post.objects.create(
        title="Tech Post 2", content="Content 2", category=category1, is_published=True
    )
    Post.objects.create(
    ...
    print(
        f"Created {Client.objects.count()} clients and {Category.objects.count()} categories"
    )
    ...
    property_filter_method = filter_generator._create_property_filter_method(
        "uppercase_raison", "icontains"
    )

    # Test filtering for "TECH" (should match "TECH COMPANY")
    filtered_queryset = property_filter_method(
        queryset, "uppercase_raison__icontains", "TECH"
    )
    ...
    filtered_queryset2 = property_filter_method(
        queryset, "uppercase_raison__icontains", "CONSULTING"
    )
    ...
    numeric_filter_method = filter_generator._create_property_filter_method(
        "post_count", "gt"
    )
    ...
    exact_filter_method = filter_generator._create_property_filter_method(
        "post_count", "exact"
    )
