...
def test_cache_invalidation_comprehensive():
    ...
    print(f"   Cache categories: {'✅' if cached_categories else '❌'} - {cached_categories}")
    ...
    print(f"   Cache categories après création: {'❌ INVALIDÉ' if not cached_categories_after else '✅ PRÉSENT'}")
    print(f"   Cache tags après création: {'❌ INVALIDÉ' if not cached_tags_after else '✅ PRÉSENT'}")
    print(f"   Cache general après création: {'❌ INVALIDÉ' if not cached_general_after else '✅ PRÉSENT'}")
    ...
    print(f"   Cache categories après modification: {'❌ INVALIDÉ' if not cached_categories_after_update else '✅ PRÉSENT'}")
    print(f"   Cache tags après modification: {'❌ INVALIDÉ' if not cached_tags_after_update else '✅ PRÉSENT'}")
    ...
    print(f"   Cache categories après suppression: {'❌ INVALIDÉ' if not cached_categories_after_delete else '✅ PRÉSENT'}")
    print(f"   Cache tags après suppression: {'❌ INVALIDÉ' if not cached_tags_after_delete else '✅ PRÉSENT'}")
    ...
    print(f"   Cache categories après création tag: {'❌ INVALIDÉ' if not cached_categories_after_tag else '✅ PRÉSENT'}")
    print(f"   Cache tags après création tag: {'❌ INVALIDÉ' if not cached_tags_after_tag else '✅ PRÉSENT'}")
