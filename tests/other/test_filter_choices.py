...
def test_filter_choices():
    ...
    if author_in_filter:
        ...
        print(f"author__in choices: {list(author_in_filter.queryset.values_list('id', 'username'))}")
        print()
    ...
    if post_in_filter:
        ...
        print(f"post__in choices: {list(post_in_filter.queryset.values_list('id', 'title'))}")
        print()
