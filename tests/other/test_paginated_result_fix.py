...
def test_paginated_result_import():
    ...
    try:
        from django_graphql_auto.generators.queries import PaginatedResult
...
def main():
    ...
    if all(results):
        ...
        print("La classe PaginatedResult est maintenant sérialisable et peut être mise en cache.")
